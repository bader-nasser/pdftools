...
ملحوظة: لم أنشر أيَّ تحديثاتٍ مهمةٍ إلى الآن، فحدث إذا أردتَّ استعمال البرنامج بالطريقة الرسمية الصحيحة أو لتسهيل تحديث هذا البرنامج مع غيره من البرامج باستعمال الأمر:
...
- ملحوظة: في وندز، إذا أردتَّ نسخَ مكانِ الملفِ دون كتابته بنفسك في نافذة سطر الأوامر، فاضغط على (الملف) باستعمال الزرين: الزر الأيمن للفأرة وزر (شفت) ثم اختر:
  Copy as path
