...
برنامج لاستخراج الصفحات من الملفات المبدأفة أو لدمجها مع بعضها البعض مع إمكانية اختيار بعض الصفحات من كل ملف.
...
يستعمل البرنامج برنامجا آخر لتوفير أغلبِ الخصائصِ اللازمة كي يؤديَ وظائـفَـه، وهْـو باللغة الإنجليزية.
انظر https://oclif.io

## لماذا البرنامج بدون واجهة؟

أحتاج شخصيا إلى برنامج سهل يقوم بهذين الأمرينِ الهامَّينِ عندي:

- إمّا أن أُعطـيَـه اسم الملف المبدأف (أو مكان وجوده في الجهاز) وملفا آخر فيه الصفحات التي أرغب باستخراجها منه، فيستخرجها
- أو أن أعطيَـه ملفا واحدا فقط فيه إشارة للملفات التي أود منه أن يدمجها مع بعضها البعض، بالصفحات التي أرغب فيها من كل ملف، فيدمجها (وأفكر أن أضيف استعمال ملفات الورد والبوربـينت وربما الصور!)
...
ملحوظة أخرى: الملفات التي يتعامل معها البرامج هي ملفات نصية بصيغتي (TXT و JSON) وليست مستنداتٍ، لذا ينبغي أن تُستعمل برامج تحرير النصوص للتعامل معها لا برامج تحرير المستندات.

برامج تحرير النصوص من مثل:
...
- ملحوظة: الأمر (استخراج الصفحات) له عدة اختصارات وهي:
